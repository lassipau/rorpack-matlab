...
For some special PDEs, such as 1D heat or wave equations with constant coefficients, the values $P(i\gw_k)$ may have explicit expressions, but these are very limited special cases. For PDEs with spatially varying parameters there are powerful computational methods that can be used to determine $P(i\gw_k)$, such as the \textbf{Chebfun} package (\href{https://chebfun.org/}{https://chebfun.org/}) employed in \texttt{Heat1DtestCase1\_main.m} in Section~\ref{sec:Heat1D2} (``Case 2'').
...
~\\[-1ex]
  ...
  \noindent Main file name: \texttt{Heat1DtestCase1\_main.m}
...
~\\[-1ex]
  ...
  \noindent Main file name: \texttt{Heat1DtestCase2\_main.m}
...
~\\[-1ex]
  ...
  \noindent Main file name: \texttt{Heat1DtestCase3\_main.m}
...
~\\[-1ex]
  ...
  \noindent Main file name: \texttt{Heat2Dtest1\_main.m}
...
~\\[-1ex]
  ...
  \noindent Main file name: \texttt{Heat2Dtest2\_main.m}

\medskip

A similar case (but with collocated inputs and outputs) was considered in~\citel{Pau19}{Sec. 6.3}.
...
~\\[-1ex]
  ...
  \noindent Main file name: \texttt{Wave1DtestCase1\_main.m}
...
~\\[-1ex]
  ...
  \noindent Main file name: \texttt{Wave1DtestCase2\_main.m}
