...
\blue{In the example, the construction of the low-gain controller employs the \textbf{Chebfun} package in computing the required transfer function values $P(i\gw_k)$.}
