...
The following commented example file explains the typical structure and workflow of the controller construction and simulation with \RORname. The considered example cases included in the files \texttt{Heat1DCase3.m} and \texttt{Constr1DHeatCase3.m} and documented in Section~\ref{sec:Heat1D3}. Due to the properties of Matlab, the constructor routine used in the main simulation is in its own, separate, Matlab function file.
